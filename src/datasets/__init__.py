...
DATASET_DATA_SOURCES = {
    ...
    'sketchy-photos-one-hot': DATA_SOURCES['sketchy']['photos'],
    ...
    'sketchy-sketches-one-hot': DATA_SOURCES['sketchy']['sketches'],
    ...
    'sketchy-test-photos-one-hot': DATA_SOURCES['sketchy_test']['photos'],
    ...
    'sketchy-test-sketches-one-hot': DATA_SOURCES['sketchy_test']['sketches'],
