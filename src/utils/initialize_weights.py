...
""" Functions for network weight initialization. """
...
def initialize_weights(model, conv_mean=0.2, conv_std=0.0, batch_norm_mean=0.2,
    ...
    :type: float
    :param conv_std: the standard deviation for the Normal distribution for the convolutional
    layer weights
    :type: float
    :param batch_norm_mean: the mean for the Normal distribution for the batch normalization
    layer weights
    :type: float
    :param batch_norm_std: the standard deviation for the Normal distribution for the batch
