...
@click.option(
    "--dataset-name",
    prompt="Dataset name",
    help="Name of the dataset for which classes must be created.",
    type=click.Choice(["sketchy-photos", "sketchy-sketches", "sketchy-test-photos", "sketchy-test-sketches", 'sketchy-test-photos-multimodal', 'sketchy-test-sketches-multimodal']),
)
@click.option(
    "--distance",
    prompt="Distance",
...
@click.option(
    "--dataset-name",
    prompt="Dataset name",
    help="Name of the dataset for metadata creation.",
